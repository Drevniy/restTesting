...
public class User {
	...
	public User(String login, Integer id, String avatar_url, String gravatar_id, String url, String html_url,
			String followers_url, String followings_url, String gists_url, String starred_url, String subscriptions_url,
			...
			String hireable, String bio, Integer public_repos, Integer public_gists, Integer followers,
	...
	public String toString() {
		return "User [login=" + login + ", id=" + id + ", avatar_url=" + avatar_url + ", gravatar_id=" + gravatar_id
				+ ", url=" + url + ", html_url=" + html_url + ", followers_url=" + followers_url + ", followings_url="
				+ followings_url + ", gists_url=" + gists_url + ", starred_url=" + starred_url + ", subscriptions_url="
